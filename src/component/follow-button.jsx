...
const FollowButton = ({ userId, onFollowChange }) => {
  ...
  const checkConnectionStatus = async () => {
    try {
      const response = await axios.get(`https://updatedbackendcc.onrender.com/api/users/connections/${userId}`, config)
  ...
  const sendConnectionRequest = async () => {
    try {
      setLoading(true)
      await axios.post(`https://updatedbackendcc.onrender.com/api/users/follow/${userId}`, {}, config)
  ...
  const handleUnfollow = async () => {
    try {
      setLoading(true)
      await axios.delete(`https://updatedbackendcc.onrender.com/api/users/unfollow/${userId}`, config)
      setConnectionStatus("none")
