...
const HomePage = () => {
  ...
  const fetchAnnouncements = async () => {
    ...
    try {
      const response = await fetch("https://updatedbackendcc.onrender.com/api/announcements")
      if (!response.ok) {
        throw new Error(`Failed to fetch announcements: ${response.statusText}`)
      }
      const data = await response.json()
  ...
  const fetchAchievements = async () => {
    ...
    try {
      const response = await fetch("https://updatedbackendcc.onrender.com/api/achievements")
      if (!response.ok) {
        throw new Error(`Failed to fetch achievements: ${response.statusText}`)
      }
      const data = await response.json()
  ...
  const fetchPosts = async () => {
    ...
    try {
      const res = await fetch("https://updatedbackendcc.onrender.com/api/posts")
      if (!res.ok) {
        throw new Error(`Failed to fetch posts: ${res.statusText}`)
      }
      const data = await res.json()
  ...
  const createPost = async (postData) => {
    ...
    try {
      const response = await fetch("https://updatedbackendcc.onrender.com/api/posts", {
        method: "POST",
        body: formData,
      })
  ...
  const handleLikePost = async (postId) => {
    ...
    try {
      const res = await fetch(`https://updatedbackendcc.onrender.com/api/posts/${postId}/like`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ userId: user._id }),
      })
  ...
  const handleDislikePost = async (postId) => {
    ...
    try {
      const res = await fetch(`https://updatedbackendcc.onrender.com/api/posts/${postId}/dislike`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ userId: user._id }),
      })
  ...
  const handleAddComment = async (postId, text) => {
    ...
    try {
      const res = await fetch(`https://updatedbackendcc.onrender.com/api/posts/${postId}/comment`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          text,
  ...
  const handleDeletePost = async (postId) => {
    ...
    try {
      const res = await fetch(`https://updatedbackendcc.onrender.com/api/posts/${postId}`, {
        method: "DELETE",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ userId: user._id }),
      })
  ...
  const handleReportPost = async (postId) => {
    ...
    try {
      const response = await fetch(`https://updatedbackendcc.onrender.com/api/posts/${postId}/report`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ userId: user._id, reason }),
      })
  ...
  const handleSavePost = async (postId) => {
    ...
    try {
      const response = await fetch(`https://updatedbackendcc.onrender.com/api/posts/${postId}/save`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ userId: user._id }),
      })
