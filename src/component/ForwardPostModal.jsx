...
const ForwardPostModal = ({ isOpen, onClose, onForward, post }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-slate-50 to-indigo-50 rounded-2xl shadow-2xl max-w-md w-full mx-4 max-h-[85vh] flex flex-col border border-indigo-200/50 overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-6 bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-600 text-white">
        ...
        <div className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 border-b border-indigo-200">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-4 rounded-xl border border-indigo-200 shadow-sm">
            ...
            <p className="text-sm text-gray-700 line-clamp-3 mb-3 leading-relaxed">{post?.content || "No content"}</p>
        ...
        <div className="flex-1 overflow-y-auto bg-gradient-to-b from-slate-50 to-indigo-50">
          {loading ? (
            <div className="flex flex-col justify-center items-center h-32 text-indigo-600">
              <div className="animate-spin rounded-full h-10 w-10 border-3 border-indigo-200 border-t-indigo-600 mb-3"></div>
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      ...
                      />
                      {isSelected && (
                        <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-gradient-to-r from-indigo-500 to-blue-500 rounded-full flex items-center justify-center border-2 border-white">
                    ...
                    <div className="flex-1 text-left ml-4">
                      <div className={`font-semibold ${isSelected ? "text-indigo-800" : "text-gray-900"}`}>
            ...
            <div className="flex flex-col items-center justify-center h-32 text-indigo-600">
              <div className="w-16 h-16 bg-gradient-to-r from-indigo-100 to-blue-100 rounded-full flex items-center justify-center mb-4">
                <FaSearch className="text-2xl text-indigo-500" />
              </div>
              <p className="font-medium">No conversations found</p>
              <p className="text-sm text-indigo-500 mt-1">Try adjusting your search</p>
            </div>
          )}
        </div>

        {/* Footer */}
        <div className="p-6 bg-gradient-to-r from-indigo-50 to-blue-50 border-t border-indigo-200 flex justify-end space-x-4">
          <button
            onClick={onClose}
